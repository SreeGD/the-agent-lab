"""Red-teaming — stress-test your LLM system the way an attacker would.
...
target = ChatAnthropic(model=TARGET_MODEL, temperature=0)
judge = ChatAnthropic(model=JUDGE_MODEL, temperature=0)
...
AUDIT_LOG_TEMPLATE = {
    ...
    "model":                   "exact model identifier, e.g. claude-sonnet-4-6",
    "tokens_in":               "int",
    "tokens_out":              "int",
...
if __name__ == "__main__":
    ...
    card = generate_model_card(
        "An AgenticCourse customer-support chatbot powered by claude-sonnet-4-6. "
        ...
        "prompt + LLM-as-judge output validator using claude-haiku-4-5."
    )
    print(f"\n  Purpose:")
