"""Citations via prompt instructions — verified attribution without a native API.
...
OpenAI does not expose this API surface. This variant achieves the same
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("PROMPT-BASED CITATIONS — attributed answers from numbered sources")
    print("=" * 70)
    print("  NOTE: OpenAI does not have a native citations API equivalent to")
    ...
    print(
        ...
        "  Prompt-based citations (this file / OpenAI):\n"
