...
# system built by someone who didn't think about safety. Modern GPT-4o
...
AUDIT_LOG_TEMPLATE = {
    ...
    "model":                   "exact model identifier, e.g. gpt-4o",
    "tokens_in":               "int",
    "tokens_out":              "int",
...
if __name__ == "__main__":
    ...
    card = generate_model_card(
        "An AgenticCourse customer-support chatbot powered by gpt-4o. "
        ...
        "prompt + LLM-as-judge output validator using gpt-4o-mini."
    )
    print(f"\n  Purpose:")
