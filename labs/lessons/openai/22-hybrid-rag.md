...
> **Provider variant — OpenAI (`gpt-4o`)** This lesson's code is provider-agnostic — it does not directly instantiate an LLM. No OpenAI-specific code file is needed; use the original `labs/22_hybrid_rag.py` unchanged.
